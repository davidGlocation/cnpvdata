# The name of this view in Looker is "Jefe Hacinamiento Mitigable 12"
view: jefe_hacinamiento_mitigable_12 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `cnpv2018_datos.Jefe_hacinamiento_mitigable_12` ;;
