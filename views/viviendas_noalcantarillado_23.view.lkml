# The name of this view in Looker is "Viviendas Noalcantarillado 23"
view: viviendas_noalcantarillado_23 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `cnpv2018_datos.viviendas_noalcantarillado_23` ;;
