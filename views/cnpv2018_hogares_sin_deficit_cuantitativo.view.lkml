# The name of this view in Looker is "Cnpv2018 Hogares Sin Deficit Cuantitativo"
view: cnpv2018_hogares_sin_deficit_cuantitativo {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `cnpv2018_datos.CNPV2018_HOGARES_SIN_DEFICIT_CUANTITATIVO` ;;
