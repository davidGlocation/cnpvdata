# The name of this view in Looker is "Hogares Hacinamiento Mitigable 12"
view: hogares_hacinamiento_mitigable_12 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `cnpv2018_datos.hogares_hacinamiento_mitigable_12` ;;
