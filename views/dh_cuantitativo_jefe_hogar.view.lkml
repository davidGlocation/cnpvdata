# The name of this view in Looker is "Dh Cuantitativo Jefe Hogar"
view: dh_cuantitativo_jefe_hogar {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `cnpv2018_datos.DH_CUANTITATIVO_JEFE_HOGAR` ;;
  ...
  dimension: defi_cuanti_otra_vivienda {
    type: string
    sql: ${TABLE}.DEFI_CUANTI_OTRA_VIVIENDA ;;
  }
