# The name of this view in Looker is "Dh Cualitativo Jefe Hogar"
view: dh_cualitativo_jefe_hogar {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `cnpv2018_datos.DH_CUALITATIVO_JEFE_HOGAR` ;;
  ...
  dimension: defi_cuali_acueducto {
    type: string
    sql: ${TABLE}.DEFI_CUALI_ACUEDUCTO ;;
  }

  dimension: defi_cuali_alcantarillado {
    type: string
    sql: ${TABLE}.DEFI_CUALI_ALCANTARILLADO ;;
  }

  dimension: defi_cuali_basura {
    type: string
    sql: ${TABLE}.DEFI_CUALI_BASURA ;;
  }
  ...
  dimension: defi_cuali_energia {
    type: string
    sql: ${TABLE}.DEFI_CUALI_ENERGIA ;;
  }
